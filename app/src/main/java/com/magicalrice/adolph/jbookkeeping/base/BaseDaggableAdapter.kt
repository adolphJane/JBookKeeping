 ...
 */
abstract class BaseDaggableAdapter<T>(layoutResId: Int, data: List<T>?) : BaseItemDraggableAdapter<T, BaseDaggableAdapter.DataBindingViewHolder>(layoutResId, data) {
